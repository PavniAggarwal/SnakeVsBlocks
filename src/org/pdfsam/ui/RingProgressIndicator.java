...
public class RingProgressIndicator extends ProgressCircleIndicator {
    public RingProgressIndicator() {
        this.getStylesheets().add(RingProgressIndicator.class.getResource("/application/ringprogress.css").toExternalForm());
     ...
     */
    private DoubleProperty ringWidth = new StyleableDoubleProperty(10) {
        @Override
